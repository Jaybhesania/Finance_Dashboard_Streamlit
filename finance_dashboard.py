"""
Simple Sales Dashboard built with Streamlit, Plotly, and DuckDB.
Run locally with: streamlit run finance_dashboard.py
"""
import random
import duckdb
import pandas as pd
...
st.markdown("_An early version dashboard to explore sales trends._")
...
if uploaded_file is None:
    st.info(" Please upload a file using the configuration sidebar.", icon="ℹ️")
    st.stop()

# Loading uploaded Excel data
...
def show_sales_by_business_unit():
...
# Laying out the dashboard sections
...
with top_right_column:
    show_sales_by_business_unit()

with bottom_left_column:
    show_monthly_sales_trends()

with bottom_right_column:
    show_yearly_account_sales()
